...
import useController, { IDataItem } from "./customerController";
    ...
    return(
        <Container>
            <Stack direction="horizontal">
                ...
                <Button variant="primary" className="ms-auto" onClick={openModalCreate}>Create new customer</Button>
            </Stack>
            ...
            <Modal show={openModal} onHide={closeModal} centered>
                ...
                <Modal.Title>{selectedItem?.hasOwnProperty('id') ? 'Update' : 'New'} Customer</Modal.Title>
                    </Modal.Header>
                <Modal.Body>
                ...
                <Modal.Body>
                    <Card>
                        <Card.Body>
                            ...
                            <Card.Text>Are you sure want to delete this customer? You can&apos;t undo deleted data</Card.Text>
                        </Card.Body>
                    </Card>
                </Modal.Body>
                <Modal.Footer>
